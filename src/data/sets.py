...
def split_sets_random(df, target_col, test_ratio=0.2, to_numpy=False):
    ...
    X_data, X_test, y_data, y_test = train_test_split(features, target, test_size=test_ratio, random_state=8, stratify=target)
    
    val_ratio = test_ratio / (1 - test_ratio)
    X_train, X_val, y_train, y_val = train_test_split(X_data, y_data, test_size=val_ratio, random_state=8, stratify=y_data)
